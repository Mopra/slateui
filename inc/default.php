...
function theme_get_the_password_form() {
	...
	<p>' . __( 'This content is password protected. To view it please enter your password below:', 'slate' ) . '</p>
	<p><label for="' . $label . '">' . __( 'Password:', 'slate' ) . '</label> <input name="post_password" id="' . $label . '" type="password" size="20" /> <input type="submit" name="Submit" value="' . esc_attr__( 'Submit', 'slate' ) . '" /></p></form>
	';
	return $output;
}
